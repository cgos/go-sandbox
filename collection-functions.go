...
// Index returns the first index of target string t, or
...
// Any return true if one of the strings in the slice
...
// All return true if all of the strings in the slice satisfy the predicate f
